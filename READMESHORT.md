...
`MHR-GAS` is provided for educational, testing, and research purposes only.
...
## Sources
- This project is based on [MasterHttpRelayVPN](https://github.com/therealcomerun/freedom)
